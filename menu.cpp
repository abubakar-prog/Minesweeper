...
void drawMainMenu(sf::RenderWindow& window, sf::Font& font) {
    ...
    title.setPosition(sf::Vector2f(200.0f, 50.0f));
    window.draw(title);
    drawButton(window, font, 300.0f, 180.0f, 200.0f, 50.0f, "Start New Game", 70, 130, 70, 255, 255, 255);
    drawButton(window, font, 300.0f, 250.0f, 200.0f, 50.0f, "Load Game", 70, 100, 180, 255, 255, 255);
    drawButton(window, font, 300.0f, 320.0f, 200.0f, 50.0f, "High Scores", 180, 130, 70, 255, 255, 255);
    drawButton(window, font, 300.0f, 390.0f, 200.0f, 50.0f, "Settings", 130, 70, 180, 255, 255, 255);
    drawButton(window, font, 300.0f, 460.0f, 200.0f, 50.0f, "Exit", 180, 70, 70, 255, 255, 255);
...
void drawPauseMenu(sf::RenderWindow& window, sf::Font& font) {
    ...
    overlay.setSize(sf::Vector2f(800.0f, 700.0f));
    ...
    pauseText.setPosition(sf::Vector2f(250.0f, 150.0f));
    window.draw(pauseText);
    drawButton(window, font, 300.0f, 280.0f, 200.0f, 50.0f, "Resume", 70, 130, 70, 255, 255, 255);
    drawButton(window, font, 300.0f, 350.0f, 200.0f, 50.0f, "Save Game", 70, 100, 180, 255, 255, 255);
    drawButton(window, font, 300.0f, 420.0f, 200.0f, 50.0f, "Main Menu", 180, 70, 70, 255, 255, 255);
}
void drawGameOverScreen(sf::RenderWindow& window, sf::Font& font, const sf::Texture& mineTexture, const sf::Texture& flagTexture) {
    ...
    if (gameWon) {
        ...
        message.setPosition(sf::Vector2f(280.0f, 200.0f));
        window.draw(message);
        char scoreBuffer[50];
        int idx = 0;
        scoreBuffer[idx++] = 'S';
        ...
        scoreText.setPosition(sf::Vector2f(320.0f, 270.0f));
        window.draw(scoreText);
    }
    else {
        message.setString("GAME OVER!");
        message.setFillColor(sf::Color(255, 0, 0));
        message.setPosition(sf::Vector2f(240.0f, 200.0f));
        window.draw(message);
    }
    drawButton(window, font, 300.0f, 350.0f, 200.0f, 50.0f, "New Game", 70, 130, 70, 255, 255, 255);
    drawButton(window, font, 300.0f, 420.0f, 200.0f, 50.0f, "Main Menu", 180, 70, 70, 255, 255, 255);
}
void drawHighScores(sf::RenderWindow& window, sf::Font& font) {
    ...
    title.setStyle(sf::Text::Bold);
    title.setPosition(sf::Vector2f(240.0f, 50.0f));
    window.draw(title);
    for (int i = 0; i < highScoreCount; i++) {
        ...
        scoreText.setPosition(sf::Vector2f(250.0f, 150.0f + i * 40.0f));
        window.draw(scoreText);
    }
    if (highScoreCount == 0) {
        ...
        noScores.setPosition(sf::Vector2f(280.0f, 200.0f));
        window.draw(noScores);
    }
    drawButton(window, font, 300.0f, 580.0f, 200.0f, 50.0f, "Back", 100, 100, 100, 255, 255, 255);
}
void drawSettings(sf::RenderWindow& window, sf::Font& font) {
    ...
    title.setStyle(sf::Text::Bold);
    title.setPosition(sf::Vector2f(280.0f, 50.0f));
    window.draw(title);
    ...
    diffLabel.setPosition(sf::Vector2f(250.0f, 180.0f));
    ...
    drawButton(window, font, 200.0f, 250.0f, 150.0f, 50.0f, "Easy (6x6)", easyR, easyG, easyB, 255, 255, 255);
    drawButton(window, font, 370.0f, 250.0f, 160.0f, 50.0f, "Medium (8x8)", medR, medG, medB, 255, 255, 255);
    drawButton(window, font, 200.0f, 320.0f, 330.0f, 50.0f, "Hard (10x10)", hardR, hardG, hardB, 255, 255, 255);
    char infoText[100];
    int idx = 0;
    infoText[idx++] = 'C';
    infoText[idx++] = 'u';
    ...
    if (currentGridSize >= 10) {
        infoText[idx++] = '0' + (currentGridSize / 10);
    }
    infoText[idx++] = '0' + (currentGridSize % 10);
    infoText[idx++] = 'x';
    if (currentGridSize >= 10) {
    ...
    info.setPosition(sf::Vector2f(220.0f, 420.0f));
    window.draw(info);
    drawButton(window, font, 300.0f, 550.0f, 200.0f, 50.0f, "Back", 100, 100, 100, 255, 255, 255);
}
void handleMenuInput(float mouseX, float mouseY, sf::Font& font) {
    if (isButtonClicked(mouseX, mouseY, 300.0f, 180.0f, 200.0f, 50.0f)) {
        initializeGame();
        currentScreen = SCREEN_GAME;
    }
    else if (isButtonClicked(mouseX, mouseY, 300.0f, 250.0f, 200.0f, 50.0f)) {
        loadGame();
        if (cellsRevealed > 0) {
            currentScreen = SCREEN_GAME;
        }
    }
    else if (isButtonClicked(mouseX, mouseY, 300.0f, 320.0f, 200.0f, 50.0f)) {
        currentScreen = SCREEN_SCORES;
    }
    else if (isButtonClicked(mouseX, mouseY, 300.0f, 390.0f, 200.0f, 50.0f)) {
        currentScreen = SCREEN_SETTINGS;
    }
    else if (isButtonClicked(mouseX, mouseY, 300.0f, 460.0f, 200.0f, 50.0f)) {
        exit(0);
    }
}
void handleGameInput(float mouseX, float mouseY, int button) {
    if (isButtonClicked(mouseX, mouseY, 650.0f, 15.0f, 60.0f, 30.0f)) {
        currentScreen = SCREEN_PAUSE;
        return;
    }
    if (isButtonClicked(mouseX, mouseY, 720.0f, 15.0f, 60.0f, 30.0f)) {
        currentScreen = SCREEN_MENU;
        return;
    }
    if (!gameOver && !gameWon) {
...
void handlePauseInput(float mouseX, float mouseY) {
    if (isButtonClicked(mouseX, mouseY, 300.0f, 280.0f, 200.0f, 50.0f)) {
        currentScreen = SCREEN_GAME;
    }
    else if (isButtonClicked(mouseX, mouseY, 300.0f, 350.0f, 200.0f, 50.0f)) {
        saveGame();
        currentScreen = SCREEN_GAME;
    }
    else if (isButtonClicked(mouseX, mouseY, 300.0f, 420.0f, 200.0f, 50.0f)) {
        currentScreen = SCREEN_MENU;
    }
}
void handleGameOverInput(float mouseX, float mouseY) {
    if (isButtonClicked(mouseX, mouseY, 300.0f, 350.0f, 200.0f, 50.0f)) {
        initializeGame();
        currentScreen = SCREEN_GAME;
    }
    else if (isButtonClicked(mouseX, mouseY, 300.0f, 420.0f, 200.0f, 50.0f)) {
...
void handleScoresInput(float mouseX, float mouseY) {
    if (isButtonClicked(mouseX, mouseY, 300.0f, 580.0f, 200.0f, 50.0f)) {
        currentScreen = SCREEN_MENU;
    }
}
void handleSettingsInput(float mouseX, float mouseY) {
    if (isButtonClicked(mouseX, mouseY, 200.0f, 250.0f, 150.0f, 50.0f)) {
        setDifficulty(DIFFICULTY_EASY);
        saveSettings();
    }
    else if (isButtonClicked(mouseX, mouseY, 370.0f, 250.0f, 160.0f, 50.0f)) {
        setDifficulty(DIFFICULTY_MEDIUM);
        saveSettings();
    }
    else if (isButtonClicked(mouseX, mouseY, 200.0f, 320.0f, 330.0f, 50.0f)) {
        setDifficulty(DIFFICULTY_HARD);
        saveSettings();
    }
    else if (isButtonClicked(mouseX, mouseY, 300.0f, 550.0f, 200.0f, 50.0f)) {
        currentScreen = SCREEN_MENU;
    }
}